...
export default function Footer() {
  return (
    <footer className="w-screen -mx-[calc((100vw-100%)/2)] bg-linear-to-b from-slate-700 to-slate-800">
      {/* Main Content */}
          ...
          <div className="text-white">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-gray-300">Av. Corrientes 2174 Local 192, C1045 Cdad. Autónoma de Buenos Aires<br />Buenos Aires, Argentina</p>
              </div>
              <div className="flex items-center gap-2">
                <MdPhone className="text-orange-400 shrink-0" size={18} />
                <a href="tel:+541123345678" className="text-sm text-gray-300 hover:text-white transition-colors">+54 11 2334-5678</a>
              </div>
              <div className="flex items-center gap-2">
                <MdEmail className="text-orange-400 shrink-0" size={18} />
                <a href="mailto:contacto@joanlunaviajes.com" className="text-sm text-gray-300 hover:text-white transition-colors">contacto@joanlunaviajes.com</a>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-gray-600 py-6 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
          <p>© 2025 Joanluna Viajes. Todos los derechos reservados.</p>
