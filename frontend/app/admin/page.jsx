  ...
  return (
    <div className='space-y-6'>
      ...
      <section className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4'>
        ...
        <StatCard title='Revenue estimado' value={formatUSD(monthlyRevenue)} icon={<LuTrendingUp />} growth='+8.4%' />
      </section>
      ...
      <section className='rounded-2xl border border-default bg-surface overflow-hidden'>
        <div className='p-4 md:p-5 border-b border-default flex items-center justify-between'>
          <div>
            <h3 className='text-2xl font-bold'>Ultimas cotizaciones</h3>
            <p className='text-sm text-muted'>Solicitudes recientes pendientes de gestion.</p>
          </div>
